...
const DjiHeroVideo = ({ name, meta, videoUrl, imageUrl }) => {
  return (
    <div className="relative w-full h-[calc(100vh-80px)] overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-black/60 z-10 flex flex-col justify-center items-center text-white text-center px-6">
        <h1 className="text-4xl md:text-5xl font-bold mb-4 drop-shadow-lg">{name}</h1>
        <p className="text-lg md:text-xl max-w-2xl drop-shadow-md">{meta?.description}</p>
        <button
